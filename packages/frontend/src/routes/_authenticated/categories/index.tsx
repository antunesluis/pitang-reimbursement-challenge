...
import { type CreateCategoryFormData, createCategorySchema } from "@/schemas/category.schema.ts";
          ...
          <CardContent>
            <form className="flex items-end gap-3" onSubmit={handleSubmit(onSubmit)}>
              <div className="flex-1 space-y-2">
                ...
                <Input id="name" placeholder="Transporte" {...register("name")} />
                ...
                <TableRow key={cat.id}>
                  ...
                  <TableCell>
                    <div className="flex gap-1">
                      {editingId === cat.id ? (
                        <>
                          <Button onClick={() => saveEdit(cat.id)} size="sm" variant="default">
                            Save
                          </Button>
                        ...
                        <>
                          <Button onClick={() => startEdit(cat)} size="sm" variant="outline">
                            Rename
                          </Button>
                          <Button
                            onClick={() => toggleActive(cat)}
                            size="sm"
                            variant={cat.active ? "destructive" : "default"}
                          >
