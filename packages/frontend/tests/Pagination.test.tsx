...
describe('Pagination', () => {
    ...
    it('renders page buttons for multiple pages', () => {
        render(<Pagination onPageChange={vi.fn()} page={1} totalPages={5} />);
    ...
    it('disables next button on last page', () => {
        render(<Pagination onPageChange={vi.fn()} page={5} totalPages={5} />);
    ...
    it('calls onPageChange when clicking a page number', async () => {
        ...
        render(
            <Pagination onPageChange={onPageChange} page={1} totalPages={5} />,
        );
    ...
    it('calls onPageChange with next page on next click', async () => {
        ...
        render(
            <Pagination onPageChange={onPageChange} page={2} totalPages={5} />,
        );
    ...
    it('highlights current page with default variant', () => {
        render(<Pagination onPageChange={vi.fn()} page={3} totalPages={5} />);
